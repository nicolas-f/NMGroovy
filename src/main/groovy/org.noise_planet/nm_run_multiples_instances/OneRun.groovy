 ...
 */
        ...
        String shpPath = "/home/nicolas/data/debug_outofbound/couches_clean1/"
        if (!H2) {
            ...
            def database_path = "/home/nicolas/data/gcbugnoisemodelling/debug_pointnoisemap/database"
...
// Ouverture de la base de donnees PostGreSQL qui recueillera les infos
        ...
        try {
            ...
            if (clean) {
                ...
                sql.execute([f:shpPath+"foresx.shp"],"CALL File_table(:f,'receivers2')")
